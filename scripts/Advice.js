...
function drawAdviceCanvas(ctx, TSHLevel, TSH) {
	ctx.font = "22px Arial";
	ctx.fillStyle = "black";
	ctx.fillText("Your current TSH is " + TSH + ".", 25, 320);
...
function writeAdvice(ctx, level) {
	...
	ctx.fillText("Your TSH-level is " + level + ".", 25, 380);
...
function levelAMeter(ctx, TSH) {
	if (TSH <= 3) {
		var cg = new RGraph.CornerGauge("AdviceCanvas", 0, 3, TSH).Set("chart.colors.ranges", [
			[0.5, 3, "red"],
			[0.2, 0.5, "yellow"],
			[0.01, 0.1, "#0f0"]
			]);
		...
		var cg = new RGraph.CornerGauge("AdviceCanvas", 0, TSH, TSH).Set("chart.colors.ranges", [
			[0.5, 3, "red"],
			[0.1, 0.5, "yellow"],
			[0.01, 0.1, "#0f0"],
			[3.01, TSH, "red"]
...
function levelBMeter(ctx, TSH) {
	if (TSH <= 3) {
		var bcg = new RGraph.CornerGauge("AdviceCanvas", 0, 3, TSH).Set("chart.colors.ranges", [
			[2.01, 3, "red"],
			[0.51, 2, "yellow"],
			[0.01, 0.5, "#0f0"],
			[0.01, 0.1, "yellow"]
		...
		var bcg = new RGraph.CornerGauge("AdviceCanvas", 0, TSH, TSH).Set("chart.colors.ranges", [
			[2.01, 3, "red"],
			[0.51, 2, "yellow"],
			[0.1, 0.5, "#0f0"],
			[0.01, 0.1, "yellow"],
...
function levelAMeter(ctx, TSH) {
	if (TSH <= 15) {
		var ccg = new RGraph.CornerGauge("AdviceCanvas", 0, 15, TSH).Set("chart.colors.ranges", [
			[10.01, 15, "red"],
			[2.01, 10, "yellow"],
			[0.35, 2, "#0f0"],
			[0.1, 0.34, "yellow"]
		...
		var ccg = new RGraph.CornerGauge("AdviceCanvas", 0, TSH, TSH).Set("chart.colors.ranges", [
			[10.01, 15, "red"],
			[2.01, 10, "yellow"],
			[0.35, 2, "#0f0"],
			[0.1, 0.34, "yellow"],
...
function drawMeter(g) {
	g.Set("chart.value.text.units.post", " m1U/L")
